...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT, materials[13], 0);
		gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_DIFFUSE, materials[13], 4);
		gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, materials[13], 8);
		gl2.glMaterialf(GL2.GL_FRONT_AND_BACK, GL2.GL_SHININESS, materials[13][12]);
	...
	public void init(GLAutoDrawable drawable) {
		...
		float red[] = {0.5f, 0.5f, 0.6f, 1};
		float blue[] = { 0.4f, 0.4f, 0.6f, 1 };
		
		float[] specular  = {0, 0, 0.8f, 1};
		float[] diffuse  = {0.3f, 0.15f, 0.15f, 1};
		
		float[] positionRed = {0,1,2,1};
		float[] positionBlue = {0,3,2,1};

		gl2.glLightfv (GL2.GL_LIGHT1, GL2.GL_AMBIENT, red,0);
		gl2.glLightfv (GL2.GL_LIGHT1, GL2.GL_DIFFUSE, diffuse,0);
		gl2.glLightfv (GL2.GL_LIGHT1, GL2.GL_SPECULAR, specular,0);
		
		gl2.glLightfv (GL2.GL_LIGHT1, GL2.GL_POSITION, positionRed, 0);
		gl2.glEnable(GL2.GL_LIGHT1);
		
		gl2.glLightfv (GL2.GL_LIGHT2, GL2.GL_AMBIENT, blue,0);
		gl2.glLightfv (GL2.GL_LIGHT2, GL2.GL_DIFFUSE, diffuse,0);
		gl2.glLightfv (GL2.GL_LIGHT2, GL2.GL_SPECULAR, specular,0);
		
		gl2.glLightfv (GL2.GL_LIGHT2, GL2.GL_POSITION, positionBlue, 0);
